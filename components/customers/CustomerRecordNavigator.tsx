...
export interface CustomerRecordNavigatorProps {
  index: number;
  total: number;
  prevId: string | null;
  nextId: string | null;
...
export default function CustomerRecordNavigator({
  index,
  total,
  prevId,
  nextId,
  ...
  return (
    <div
      ...
      aria-label="Customer record navigation"
    >
      <button
        type="button"
