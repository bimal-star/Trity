...
export interface SupplierRecordNavigatorProps {
  index: number;
  total: number;
  prevId: string | null;
  nextId: string | null;
...
export default function SupplierRecordNavigator({
  index,
  total,
  prevId,
  nextId,
  ...
  return (
    <div
      ...
      aria-label="Supplier record navigation"
    >
      <button
        type="button"
