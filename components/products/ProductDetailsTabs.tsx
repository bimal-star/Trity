...
export default function ProductDetailsTabs({ product }: ProductDetailsTabsProps) {
  ...
  return (
    <div className="mt-6">
      <div className="flex overflow-x-auto gap-1 border-b border-gray-200 dark:border-gray-700 mb-4 text-sm scrollbar-hide pb-px">
        {[
          ['variants', 'Variants'],
          ['barcodes', 'Barcodes'],
          ...
          <button
            key={key}
            className={`flex-shrink-0 px-3 py-1.5 rounded-t-md border-b-2 transition-colors whitespace-nowrap ${
              activeTab === key
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  {barcodes.map((b) => (
                    <tr key={b.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/40">
                      ...
                      <td className="px-3 py-2">
                        <BoolIcon value={!!b.is_primary} />
                      </td>
                      <td className="px-3 py-2">
                        <BoolIcon value={!!b.is_active} />
                      </td>
                      <td className="px-3 py-2 text-right">
                        <button
                          type="button"
