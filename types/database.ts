...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      category_nodes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'category_nodes_tenant_id_fkey';
            columns: ['tenant_id'];
            isOneToOne: false;
            referencedRelation: 'tenants';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'fk_category_nodes_tier';
            columns: ['tenant_id', 'tier_number'];
            isOneToOne: false;
            referencedRelation: 'category_tiers';
            referencedColumns: ['tenant_id', 'tier_number'];
          },
        ];
      };
      category_tiers: {
        ...
        Relationships: [
          {
            foreignKeyName: 'category_tiers_tenant_id_fkey';
            columns: ['tenant_id'];
            isOneToOne: false;
            referencedRelation: 'tenants';
            referencedColumns: ['id'];
      ...
      product_category_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: 'product_category_assignments_category_node_id_fkey';
          ...
          {
            foreignKeyName: 'product_category_assignments_tenant_id_fkey';
            columns: ['tenant_id'];
            isOneToOne: false;
            referencedRelation: 'tenants';
            referencedColumns: ['id'];
    ...
    Enums: {
      ...
      unit_type: 'weight' | 'volume' | 'length' | 'area' | 'count' | 'time' | 'temperature';
    };
    CompositeTypes: {
      [_ in never]: never;
    };
