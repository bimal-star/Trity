...
### 1. `docs/schema-isolation/SCHEMA_ISOLATION_IMPLEMENTATION.md`
...
### 2. `docs/schema-isolation/SCHEMA_ISOLATION_SETUP.md`
...
2. Run: Copy table SQL from docs/schema-isolation/SCHEMA_ISOLATION_SETUP.md
