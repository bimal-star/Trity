...
| `docs/reference/MIGRATION_GUIDE_depends_on_workstream_id.md` | Migration guide.                                                               |
| `PROJECT_DOCUMENTATION.md`                                   | Project docs (repo root).                                                      |
| `TRITY_CONTEXT.md`                                           | Context docs (repo root).                                                      |
| `docs/reference/schema_analysis_report.md`                   | Schema analysis.                                                               |
| `docs/reference/supabase-multi-tenant-audit-report.md`       | Audit report.                                                                  |
