...
- **UI Usage:** Historical docs mention `app/groups/page.tsx`, but that route is not present in this checkout.
...
2. Historical groups page reference (`app/groups/page.tsx`) - not present in this checkout
...
**Pages:**
- Historical groups page reference: `app/groups/page.tsx` (not present in this checkout)
