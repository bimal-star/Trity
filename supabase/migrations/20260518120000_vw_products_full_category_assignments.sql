-- Align vw_products_full.category_names with tier-based product_category_assignments
-- (product detail page) while keeping legacy product_categories as fallback.
