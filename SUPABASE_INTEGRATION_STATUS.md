...
2. **Deploy the relevant migration** to clear materialized view linter warnings:
   ```bash
   # Apply the required SQL file from supabase/migrations/ in timestamp order
   # using your normal Supabase migration workflow.
   ```
