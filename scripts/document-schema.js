...
`;
  ...
  markdown += `- [\`reference/SUPABASE_INTEGRATION_STATUS.md\`](reference/SUPABASE_INTEGRATION_STATUS.md) - Current database integration notes\n`;
  markdown += `- [\`../supabase/migrations/\`](../supabase/migrations/) - Checked-in migration history\n`;
